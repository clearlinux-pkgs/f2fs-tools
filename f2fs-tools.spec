...
Version  : 1.13.0
Release  : 3
URL      : https://git.kernel.org/pub/scm/linux/kernel/git/jaegeuk/f2fs-tools.git/snapshot/f2fs-tools-1.13.0.tar.gz
Source0  : https://git.kernel.org/pub/scm/linux/kernel/git/jaegeuk/f2fs-tools.git/snapshot/f2fs-tools-1.13.0.tar.gz
...
%prep
%setup -q -n f2fs-tools-1.13.0
cd %{_builddir}/f2fs-tools-1.13.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581358459
...
cp %{_builddir}/f2fs-tools-1.13.0/COPYING %{buildroot}/usr/share/package-licenses/f2fs-tools/a55afe19b58d728b586547acb09862752d4f1b76
%make_install
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libf2fs.so.7
/usr/lib64/libf2fs.so.7.0.0
/usr/lib64/libf2fs_format.so.6
/usr/lib64/libf2fs_format.so.6.0.0
