...
Source0  : https://git.kernel.org/pub/scm/linux/kernel/git/jaegeuk/f2fs-tools.git/snapshot/f2fs-tools-1.14.0.tar.gz
...
%prep
%setup -q -n f2fs-tools-1.14.0
cd %{_builddir}/f2fs-tools-1.14.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598635257
...
cp %{_builddir}/f2fs-tools-1.14.0/COPYING %{buildroot}/usr/share/package-licenses/f2fs-tools/a55afe19b58d728b586547acb09862752d4f1b76
%make_install
